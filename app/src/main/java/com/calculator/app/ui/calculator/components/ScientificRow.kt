...
fun ScientificRow(
    ...
    BoxWithConstraints(modifier = modifier) {
        ...
        // See ButtonGrid.kt for the rationale on capturing the ButtonGroupScope
        // so weight / animateWidth modifiers can be applied inside each
        // customItem's @Composable content, and for the slack-lints
        // DeprecatedCall suppression (this resolves to the non-deprecated
        // overload; the lint check flags by function name).
        // overflowIndicator: row is sized to fit; never overflows.
